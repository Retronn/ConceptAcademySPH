...
// Static components
import LettersCrossedIcon from "./static/LettersCrossedIcon";
import BottomDashedBorder from "./static/BottomDashedBorder";
import BookmarkIcon from "./static/BookmarkIcon";



function TestQuestion({setTestQuestions,...props}: any){
    ...
    function markQuestionForReview(){
        ...
        if(props.question.isMarked){
            ...
            setTestQuestions((testQuestions: any)=>{
                return testQuestions.map((testQuestion:any,index:number)=>{
