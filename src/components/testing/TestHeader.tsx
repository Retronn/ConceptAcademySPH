...
import HighlightIcon from "./static/HighlightIcon";
import NoteIcon from "./static/NoteIcon";
import MoreIcon from "./static/MoreIcon";
import TimerIcon from "./static/TimerIcon";
import TimerCountdown from "./TimerCountdown";
import WarningIcon from "./static/WarningIcon";
import ExitIcon from "./static/ExitIcon";


function TestHeader(props: any){
    ...
    const directionRulesRef = useRef<HTMLDivElement | null>(null);
    const directionsButtonRef = useRef<HTMLButtonElement | null>(null);
    const moreOptionsRef =useRef<HTMLDivElement | null>(null);
    const moreOptionsButtonRef =useRef<HTMLButtonElement | null>(null);
    useEffect(()=>{

        function handleClickOutide (event: any){
            if(scaler===1 && directionRulesRef.current && directionsButtonRef.current &&
            ...
            if(moreOptionsDispay==="flex" && moreOptionsRef.current && moreOptionsButtonRef.current &&
