...
import AddNoteIcon from "./static/AddNoteIcon";
import TrashBinIcon from "./static/TrashBinIcon";
import UnderlineIcon from "./static/UnderlineIcon";
import ArrowIcon from "./static/ArrowIcon";
import ReviewPage from "./ReviewPage";

function TestBody({question,setTestQuestions,testQuestions,changeQuestion, isReviewActive, setIsReviewActive}: any){
        ...
        <div className={styles.testBody} style={{display: (isReviewActive) ? "none" : "flex"}}>
            ...
            <div id={styles.toolbar} style={{
                ...
                <button className={styles.highlight} id={styles.deleteHighlight}>
                    <TrashBinIcon  color={colors.mainBlack}/>
                </button>
